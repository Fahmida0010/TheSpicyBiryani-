...
export default function ItemsPage() {
  ...
  // Skeleton component
  const SkeletonCard = () => (
    <div className="animate-pulse bg-gray-200 dark:bg-gray-700 rounded-2xl overflow-hidden shadow-md h-[400px]"></div>
  );
        ...
        {loading
          ...
          : filtered.map(item => (
            ...
            >
              ...
              <div className="p-5">
                <p className="text-gray-600 dark:text-gray-300 text-sm md:text-base line-clamp-3 min-h-[4.5rem]">
                ...
                <Link href={`/items/${item._id}`} className="block mt-6">
                  <button className="w-full bg-gradient-to-r from-green-600 to-red-700 hover:from-green-700 hover:to-red-800 text-white font-semibold py-3 px-6 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-md flex items-center justify-center gap-2">
